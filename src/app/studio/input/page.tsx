...
return(
<>
<Input placeholder="Size small" size="sm" />
<Input placeholder="Size medium" size="md" />
<Input placeholder=" Size large" size="lg" />
<Input placeholder="Size full" size="full" />      
</>
)}
`
const InputPage=()=>{
    ...
    return(
       <div className="  min-h-screen ">
          <header className="   w-full  text-black dark:text-white h-[60px] flex items-center justify-end space-x-6 p-2">
            ...
            <div className="  w-full  flex flex-col items-center justify-center mt-12 space-y-6  " >
             ...
             A collection of unique input components built with React and Tailwind CSS, designed for modern projects.
              </p>
       ...
       <Input/>
        ...
        `}
            ...
            <div className="mt-3 md:mt-6 ">
          <p className="text-2xl font-semibold" >Input Variants</p>
          </div>
          <div className="space-x-3 mt-1 " >
          ...
          <div className="relative" >
            <div className="border  border-zinc-600/15 rounded-md   h-[360px] overflow-hidden" >
            {variants==='preview' && (
         <div className=" h-full  grid grid-cols-1 md:grid-cols-3  p-6 gap-3 place-items-center">
         <Input variant="filled" />
         <Input variant="elevated" />
        <Input variant="outlined" />
      </div>
...
`}
              ...
              <div className="mt-3 md:mt-6 ">
          <p className="text-2xl font-semibold" >Input Sizes</p>
          </div>
          <div className="space-x-3 mt-1 " >
          ...
          <div className="relative" >
            ...
            {sizes==='preview' && (
             <div className=" h-full grid grid-cols-1 md:grid-cols-2  p-6 gap-3 place-items-center">
             <Input placeholder="Size small" size="sm" />
             <Input placeholder="Size medium" size="md" />
             <Input placeholder=" Size large" size="lg" />
             <Input   placeholder="Size full" size="full" />
